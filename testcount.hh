...
#ifndef CLICK_TCPCounter_HH
#define CLICK_TCPCounter_HH
...
/*
=c
TCPCounter([I<keywords COUNT_CALL, BYTE_COUNT_CALL>])
=s counters
...
class TCPCounter : public Element { public:

    TCPCounter() CLICK_COLD;
    ~TCPCounter() CLICK_COLD;
