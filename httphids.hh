...
#ifndef CLICK_HTTPHIDS_HH
#define CLICK_HTTPHIDS_HH
...
HttpHids([I<keywords COUNT_CALL, BYTE_COUNT_CALL>])
...
class HttpHids : public Element { public:

    HttpHids() CLICK_COLD;
    ~HttpHids() CLICK_COLD;

    const char *class_name() const		{ return "HttpHids"; }
